...
const AuthFlow = ({ login }: { login: () => void }) => {
  return (
    <>
      ...
      <div className="flex flex-col items-center ">
        ...
        <Button
          onClick={login}
          variant="link"
          className="text-base font-normal text-foreground flex items-center gap-1 underline decoration-[#25d366] underline-offset-4 decoration-2 h-auto p-0"
        >
          Log in with passkey
